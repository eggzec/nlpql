C ======================================================================
C
C     NLPMMX : CONSTRAINED NONLINEAR MIN-MAX OPTIMIZATION
C
C     NLPMMX solves the constrained nonlinear min-max problem
C
...
C     additional variable and L additional inequality constraints
C     are introduced to get an equivalent smooth nonlinear
C     program.
C
...
C                least N + L + 1.
C      LMNN2   : Dimension of U, must be equal to M + L + 2*N + 4.
...
C ======================================================================
C
      SUBROUTINE NLPMMX (L, M, ME, LMMAX, N, LNMAX, LMNN2, X, F, G,
...
C
     ...
     /   THEN
      ...
      IF (LWW.LT.1) THEN
         ...
         RETURN
      ENDIF
      CALL NLDFTW (4, L, M, ME, LMMAX, N, LNMAX, LMNN2, X, F, G,
